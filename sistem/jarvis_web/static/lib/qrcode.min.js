/**
 * EasyQRCodeJS / QRCode.js standalone lightweight pure JavaScript library
 */
(function(root, factory) {
    ...
    QRCode.prototype.makeCode = function(sText) {
        ...
        var nBlockWidth = nWidth / nCount;
        var nBlockHeight = nHeight / nCount;
        ...
        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                if (this._oQRCode.isDark(row, col)) {
                    ctx.fillRect(Math.round(col * nBlockWidth), Math.round(row * nBlockHeight), Math.ceil(nBlockWidth), Math.ceil(nBlockHeight));
                }
            }
        }
